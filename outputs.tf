output "system_center_virtual_machine_manager_servers" {
  ...
  value       = azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers
  sensitive   = true
}
output "system_center_virtual_machine_manager_servers_custom_location_id" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.custom_location_id]
}
output "system_center_virtual_machine_manager_servers_fqdn" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.fqdn]
}
output "system_center_virtual_machine_manager_servers_location" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.location]
}
output "system_center_virtual_machine_manager_servers_name" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.name]
}
output "system_center_virtual_machine_manager_servers_password" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.password]
  sensitive   = true
}
output "system_center_virtual_machine_manager_servers_port" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.port]
}
output "system_center_virtual_machine_manager_servers_resource_group_name" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.resource_group_name]
}
output "system_center_virtual_machine_manager_servers_tags" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.tags]
}
output "system_center_virtual_machine_manager_servers_username" {
  ...
  value       = [for k, v in azurerm_system_center_virtual_machine_manager_server.system_center_virtual_machine_manager_servers : v.username]
}
